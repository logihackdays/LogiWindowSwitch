...
// LogiWindowSwitch.cpp : 定義應用程式的類別行為。
//
...
BEGIN_MESSAGE_MAP(CLogiWindowSwitchApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CLogiWindowSwitchApp 建構

CLogiWindowSwitchApp::CLogiWindowSwitchApp()
{
	// TODO: 在此加入建構程式碼，
...
// 僅有的一個 CLogiWindowSwitchApp 物件

CLogiWindowSwitchApp theApp;


// CLogiWindowSwitchApp 初始設定

BOOL CLogiWindowSwitchApp::InitInstance()
{
